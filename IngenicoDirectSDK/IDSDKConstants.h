...
#ifndef IngenicoDirectSDK_IDSDKConstants_h
#define IngenicoDirectSDK_IDSDKConstants_h
#import  "IDSession.h"

//Keys
#define kIDSDKLocalizable           @"IDSDKLocalizable"
#define kIDImageMapping             @"kIDImageMapping"
#define kIDImageMappingInitialized  @"kIDImageMappingInitialized"
#define kIDIINMapping               @"kIDIINMapping"
#define kIDSDKBundlePath            [[NSBundle bundleForClass:[IDSession class]] pathForResource:@"IngenicoDirectSDK" ofType:@"bundle"]
#define kIDAPIVersion               @"client/v1"
