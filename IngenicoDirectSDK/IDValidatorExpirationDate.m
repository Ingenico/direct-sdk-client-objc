...
#import "IDValidationErrorExpirationDate.h"

@interface IDValidatorExpirationDate ()
...
@implementation IDValidatorExpirationDate
...
- (void)validate:(NSString *)value forPaymentRequest:(IDPaymentRequest *)request
{
    ...
    if (submittedDate == nil) {
        IDValidationErrorExpirationDate *error = [[IDValidationErrorExpirationDate alloc] init];
