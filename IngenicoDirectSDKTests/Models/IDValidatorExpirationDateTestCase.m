...
@interface IDValidatorExpirationDateTestCase : XCTestCase

@property (strong, nonatomic) IDValidatorExpirationDate *validator;
@property (strong, nonatomic) NSDate *now;
@property (strong, nonatomic) NSDate *futureDate;

@end

@interface IDValidatorExpirationDate (Testing)

- (BOOL)validateDateIsBetween:(NSDate *)now andFutureDate:(NSDate *)futureDate withDateToValidate:(NSDate *)dateToValidate;

@end

@implementation IDValidatorExpirationDateTestCase

- (void)setUp
{
    [super setUp];
    self.validator = [IDValidatorExpirationDate new];
