...
@interface IDValidatorEmailAddressTestCase : XCTestCase

@property (strong, nonatomic) IDValidatorEmailAddress *validator;

@end

@implementation IDValidatorEmailAddressTestCase

- (void)setUp
{
    [super setUp];
    self.validator = [[IDValidatorEmailAddress alloc] init];
}
