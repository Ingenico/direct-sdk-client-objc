...
@interface IDC2SCommunicator (Testing)

- (NSString *)getIINDigitsFrom:(NSString *)partialCreditCardNumber;

@end

@interface IDC2SCommunicatorTestCase : XCTestCase
@end

@implementation IDC2SCommunicatorTestCase

- (void)testIINPartialCreditCardNumberLogic
{
    IDC2SCommunicator *communicator = [IDC2SCommunicator new];
